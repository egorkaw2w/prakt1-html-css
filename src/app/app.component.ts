...
export class AppComponent {
  ...
  prodiuctsData = [
    {
      image: '1.png',
      title: 'Лучшие друзья',
      text: 'Печенье, с которым все началось! Наше фирменное печенье сшоколадной крошкой и грецкими орехами хрустящее снаружи сдостаточно толстой и липкой серединкой.',
      price: 20,
      basePrice: 20,
      weight: '2 шт/200г',
    },
  ...
  scrollTo(target: HTMLElement, product?: any): void {
    ...
    if (product) {
      this.form.patchValue({product: product.title + ' (' + product.price + ' ' + this.currensy + ')'});
    }
  }
